...
parser.add_argument("--test-server", action='store_true', help="launch.py argument: configure server for testing", default=False)
parser.add_argument("--skip-prepare-environment", action='store_true', help="launch.py argument: skip all environment preparation", default=False)
...
parser.add_argument('--start-server', action='store_true', help='start server', default=False)
